...
const RightArrow = (props: Props) => {
    return (
        <svg {...props} fill={props.color ? props.color : '#000000'} height={props.height ? props.height : '24px'} width={props.width ? props.width : '24px'} viewBox="0 -6.5 36 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
